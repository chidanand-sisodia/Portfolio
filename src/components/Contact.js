...
function Contact() {
  return (
    <section className="text-gray-700 body-font relative bg-green-100">
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white p-8 flex flex-col md:mr-auto w-full mt-10 md:mt-0">
